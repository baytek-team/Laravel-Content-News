...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    // protected $namespace = Baytek\Laravel\Content\Types\News::class;
